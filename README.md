...
A compact MP3 browser/player built for WaveTerm and narrow terminal panes.
...
- `--full-scan` reads tags with Mutagen and will take longer on big libraries.
- The track list is the file tree itself, not M3U playlists.
